...
public class Camera {
    ...
    public void init(int screenWidth, int screenHeight) {
        ...
        orthoMatrix = new Matrix4f().ortho2D(0.0f, (float) screenWidth, 0.0f, (float) screenHeight);
    }
    ...
    public void update() {
        if (needsMatrixUpdate) {
            viewMatrix = new Matrix4f()
                    .identity()
                    .translate(new Vector3f(-position.x + screenWidth/2, -position.y + screenHeight/2, 0));
